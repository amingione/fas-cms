...
const sections: Section[] = [
  {
    title: 'All Charger/Challenger Hellcat Packages',
    intro:
      'Here at FAS Motorsports, we have built and modified countless Hellcat Vehicles which has allowed us to assemble the best packages possible!',
    pkgs: [
      {
        label: 'FAS800',
        desc:
          'FAS Upper Pulley Kit, Spark Plugs, 180 Thermostat, Custom 1320Tunez engine and trans tune'
      },
      {
        label: 'FAS850',
        desc:
          'FAS Upper Pulley Kit, Predator Lower Pulley, Upgraded Injectors, Custom 1320Tunez engine and trans tune and much more!'
      },
      {
        label: 'FAS900',
        desc:
          'Race Ported Supercharger snout, 108mm throttle body, High flow intake, Race Midpipes, FAS Upper Pulley Kit, Predator Lower Pulley, Upgraded Injectors, Custom 1320Tunez engine and trans tune and much more! (E85 Fuel Package)'
      },
      {
        label: 'FAS1000',
        desc:
          'Race Ported Supercharger, 108mm throttle body, High flow intake, Longtube headers with Race Midpipes, FAS Upper Pulley Kit, Predator Lower Pulley, Upgraded Injectors, E85, Custom 1320Tunez engine and trans tune and much more! (E85 Fuel Package)'
      },
      {
  ...
  {
    title: 'All Durango Hellcat Packages',
    intro:
      'Here at FAS Motorsports, we have built and modified countless Hellcat Vehicles which has allowed us to assemble the best packages possible!',
    pkgs: [
      {
  ...
  {
    title: 'All Jeep Trackhawk Packages',
    intro:
      'Here at FAS Motorsports, we have built and modified countless Hellcat Vehicles which has allowed us to assemble the best packages possible!',
    pkgs: [
      {
    ...
    <div className="border-t border-white/15 first:border-t-0">
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <div className="px-4 md:px-5 pb-4 pt-0 text-sm text-white/70">
              {pkg.desc}
            </div>
          </motion.div>
        )}
...
function PlatformBlock({ section }: { section: Section }) {
  return (
    ...
    >
      <div className="mb-2">
        <h3 className="text-lg md:text-xl font-borg text-white">{section.title}</h3>
      ...
      <div className="mx-auto w-full max-w-5xl px-4 md:px-0">
        <div className="max-w-3xl mx-auto text-center mb-6 md:mb-10">
          ...
          <p className="mt-2 text-sm text-white/70">
            Expand each package to see typical hardware and notes.
          </p>
        </div>
