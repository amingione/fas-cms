...
const Label = ({
  ...
  return (
    ...
    >
      <div className="flex max-w-[88%] items-center gap-3 min-h-[48px] rounded-full border bg-white/70 px-3 py-2 shadow-md text-sm font-semibold text-black backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white">
