...
const Label = ({
  ...
  return (
    ...
    >
      <div className="flex min-w-0 max-w-[88%] items-center gap-3 min-h-[48px] rounded-full border bg-black/20 px-3 py-2 text-sm font-semibold text-white/70 backdrop-blur-md shadow-inner shadow-white/20">
