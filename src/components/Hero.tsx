            ...
            >
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-14 h-14 lg:w-16 lg:h-16 bg-dark rounded-2xl flex items-center justify-center mx-auto mb-2 group-hover:shadow-xl transition-all duration-300 border border-gray-700/50 industrial-card`}
                    >
                      <Icon
