...
const defaultOptions: ISourceOptions = {
  ...
  interactivity: {
    ...
    events: {
      ...
      onDiv: { selectors: [], enable: false, mode: undefined, type: 'circle' },
...
const BasicParticles = ({
  ...
  const mergedOptions = useMemo(() => {
    ...
    if (typeof fullScreen === 'boolean' || typeof zIndex !== 'undefined') {
      base.fullScreen = {
        ...(base.fullScreen || {}),
        ...(typeof fullScreen === 'boolean' ? { enable: fullScreen } : {}),
        ...(typeof zIndex !== 'undefined' ? { zIndex } : {})
      } as any;
    }
    // Shallow-merge user options last
