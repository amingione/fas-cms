...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `trackingDetails[].datetime` | `datetime` | ISO 8601 | (none) | (none) | System (Shippo webhook) | Low |
| `forms[].createdAt` | `datetime` | ISO 8601 | (none) | (none) | System (Shippo webhook) | Low |
| `createdAt` | `datetime` | ISO 8601 | (none) | (none) | System (Shippo webhook) | Low |
| `updatedAt` | `datetime` | ISO 8601 | (none) | (none) | System (Shippo webhook) | Low |

## Notes

- **Purely System-Generated**: The `shipment` document is almost entirely populated by webhooks from a shipping provider (Shippo, based on the `shippoId` field). All `datetime` fields are set by the external system.
